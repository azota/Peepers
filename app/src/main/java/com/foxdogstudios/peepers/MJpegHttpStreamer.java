...
/* package */ final class MJpegHttpStreamer
{
    ...
    /* package */ void start()
    {
        Log.i("TAG", "MJpegHttpStreamer > start");
        if (mRunning)
        {
    ...
    /* package */ void stop()
    {
        Log.i("TAG", "MJpegHttpStreamer > stop");
        if (!mRunning)
        {
    ...
    {
        Log.i("TAG", "MJpegHttpStreamer > streamJpeg");
    ...
    {
        Log.i("TAG", "MJpegHttpStreamer > workerRun");
        while (mRunning)
        {
            try
            {
    ...
    {
        Log.i("TAG", "MJpegHttpStreamer > acceptAndStream");
        ...
        try
        {
            ...
            //yhpark
            Socket cs = new Socket("10.52.214.146", 9000);
            ...
            do
            {
                try
                {
                    ...
                    Log.i("TAG", "MJpegHttpStreamer > serverSocket.accept");
                } // try
            ...
            while (mRunning)
            {
                ...
                stream.flush();
                Log.i("TAG", "MJpegHttpStreamer > stream.writeBytes");
        ...
        finally
        {
            if (stream != null)
            {
                ...
                {
                    stream.close();
                    Log.i("TAG", "MJpegHttpStreamer > stream.close");
                } // try
            ...
            if (socket != null)
            {
                ...
                {
                    socket.close();
                    Log.i("TAG", "MJpegHttpStreamer > socket.close");
                } // try
            ...
            if (serverSocket != null)
            {
                ...
                {
                    serverSocket.close();
                    Log.i("TAG", "MJpegHttpStreamer > serverSocket.close");
                } // try
