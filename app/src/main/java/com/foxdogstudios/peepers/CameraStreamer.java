...
/* package */ final class CameraStreamer extends Object
{
        ...
        public void handleMessage(final Message message)
        {
            switch (message.what)
            {
                case MESSAGE_TRY_START_STREAMING:
                    Log.i("TAG", "CameraStreamer > handleMessage > MESSAGE_TRY_START_STREAMING");
                    tryStartStreaming();
                    break;
                case MESSAGE_SEND_PREVIEW_FRAME:
                    Log.i("TAG", "CameraStreamer > handleMessage > MESSAGE_SEND_PREVIEW_FRAME");
    ...
    {
        Log.i("TAG", "CameraStreamer > startStreamingIfRunning");
        ...
        synchronized (mLock)
        {
            if (!mRunning)
            {
                Log.i("TAG", "CameraStreamer > startStreamingIfRunning > streamer.stop");
                streamer.stop();
                camera.release();
                return;
            } // if
    ...
    private final Camera.PreviewCallback mPreviewCallback = new Camera.PreviewCallback()
    {
        ...
        {
            Log.i("TAG", "CameraStreamer > onPreviewFrame");
   ...
   {
        Log.i("TAG", "CameraStreamer > sendPreviewFrame");
